...
public class ImageAnimator {
        ...
        public void nominal(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                            int maxHeight) {

            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
        ...
        public void window_left(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                                int maxHeight) {
            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
                    Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            ...
            while (isRunning) {
                ...
                try {
                    ...
                    for (int j = 0; j < leafNum; j++) {
                        ...
                        src.set(j * perWidth,
                                0,
                                (int) (j * perWidth + ((float) runMills / (float) duration)
                                        * perWidth), maxHeight);
                        dst.set(j * perWidth,
                                0,
                                (int) (j * perWidth + ((float) runMills / (float) duration)
        ...
        public void window_down(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                                int maxHeight) {
            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
                    Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            int dx = (maxWidth - bitmap.getWidth()) / 2;
            ...
            while (isRunning) {
                ...
                try {
                    ...
                    for (int j = 0; j < leafNum; j++) {
                        src.set(0,
                                (int) ((j + 1) * perHeight - ((float) runMills / (float) duration)
        ...
        public void window_right(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                                 int maxHeight) {
            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
                    Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            int dx = (maxWidth - bitmap.getWidth()) / 2;
        ...
        public void window_up(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                              int maxHeight) {
            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
                    Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            int dx = (maxWidth - bitmap.getWidth()) / 2;
        ...
        // 向外小黑块
        public void black_away(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                               int maxHeight) {
            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
                    Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            int dx = (maxWidth - bitmap.getWidth()) / 2;
            ...
            for (int i = 0; i < array.length; i++) {
                for (int j = 0; j < array[i].length; j++) {
                    array[i][j] = new Rect();
                    array[i][j].set(j * perWidth, i * perHeight,
                            (j + 1) * perWidth, (i + 1) * perHeight);

                    if (j == array[i].length - 1) {
                        array[i][j].set(maxWidth - perWidth, array[i][j].top,
                                maxWidth, array[i][j].bottom);
                    }

                    if (i == array.length - 1) {
                        array[i][j].set(array[i][j].left, maxHeight - perHeight,
                                array[i][j].right, maxHeight);
                    }
                }
            }
        ...
        // 向内小黑块
        public void black_in(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                             int maxHeight) {
            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
                    Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            int dx = (maxWidth - bitmap.getWidth()) / 2;
            ...
            while (isRunning) {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length; i++) {
                        for (int j = 0; j < array[i].length; j++) {
                            drawRect.set(array[i][j]);
                            int _dx = (int) (((float) runMills / (float) duration)
                                    * drawRect.width() / 2);
                            int _dy = (int) (((float) runMills / (float) duration)
                                    * drawRect.height() / 2);
        ...
        // 从左向右擦除
        public void clean_left(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                               int maxHeight) {
            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
                    Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            int Num = 1;
        ...
        // 从右向左擦除
        public void clean_right(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                                int maxHeight) {
            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
                    Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            int Num = 1;
        ...
        public void show_bitmap(SurfaceHolder holder, Bitmap bitmap, int maxWidth,
                                int maxHeight) {
            PaintFlagsDrawFilter pdf = new PaintFlagsDrawFilter(0,
                    Paint.ANTI_ALIAS_FLAG | Paint.FILTER_BITMAP_FLAG);
            int Num = 1;
